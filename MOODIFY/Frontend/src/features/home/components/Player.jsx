...
const Player = () => {
    const { song, handleNextSong, handlePreviousSong } = useSong()
    ...
    return (
        <div className="player">
            ...
            <div className="player__controls">
                ...
                {/* Previous Song */}
                <button className="player__btn player__btn--skip" onClick={handlePreviousSong} title="Previous song">
                    <svg viewBox="0 0 24 24" fill="currentColor" strokeWidth="2" width="20" height="20">
                ...
                {/* Next Song */}
                <button className="player__btn player__btn--skip" onClick={handleNextSong} title="Next song">
                    <svg viewBox="0 0 24 24" fill="currentColor" strokeWidth="2" width="20" height="20">
